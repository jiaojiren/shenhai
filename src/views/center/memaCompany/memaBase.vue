  ...
  <div>
    <div>
      <div class="ccenter">
            ...
            <div class="item" v-for="item in list" :key="item.pk_Company_Cor">
              <div class="pic">
                <img
                  ...
                  alt=""
                /><img v-else src="@/assets/images/center/u44.png" alt="" />
              </div>
              <div class="pro">
                <p class="title">{{ item.PartyBInfo.CompanyName }}</p>
                <div class="status">
                  <span>基地位置：山东省青岛市崂山区xx路xx号产业园区</span>
                </div>
                <div class="type">
                  <span>基地成立日期：2020-10-11</span>
                </div>
                <div class="area">
                  <span>基地简介：建设与1999年，占地面积为190平方米</span>
                </div>
              </div>
              <div class="opt">
        ...
        <div class="right">
          <div class="btn" @click="addCooperate">上传基地信息</div>
          <div class="table">
            <p>课程中心</p>
            <div class="wrap">
